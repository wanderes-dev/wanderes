    ...
    messages.append(
        AIMessage(
            ...
            content=(
                ...
                "them to do this for you). Lead with real, confident help "
                "- do NOT open by saying you don't have data or apologizing "
                "for lacking specific information (never start with "
                "something like 'unfortunately I don't have data for "
                "this'); a real travel consultant asked about something "
                "outside their usual reference material just helps, the "
                "same way. Mention that these particular suggestions come "
                "from your own knowledge rather than our verified dataset "
                "briefly and in passing - so the traveler knows to double-"
                "check current details - not as an apology or a caveat "
